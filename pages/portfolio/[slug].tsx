...
import { ArrowLeft, Calendar, Tag, Code, ExternalLink, Github } from 'lucide-react';
...
export default function ProjectDetail({ project }: { project: Project }) {
  ...
  const metaContent = {
    fr: {
      title: `${project.title.fr} - Portfolio - Tao Jouet`,
      description: project.description.fr
    },
    en: {
      title: `${project.title.en} - Portfolio - Tao Jouet`,
            ...
            {(project.demoUrl || project.githubUrl) && (
              <div className="flex flex-wrap gap-4 mt-6">
                {project.demoUrl && (
                  <Button
                    variant="outline"
                    className="flex items-center gap-2 border-[#3B82F6] text-[#3B82F6] hover:bg-[#3B82F6]/10"
                    asChild
                  >
                    <a
                    ...
                    >
                      ...
                      {language === 'fr' ? 'Voir la plateforme' : 'View platform'}
                    </a>
                  </Button>
                )}
                {project.githubUrl && (
                  <Button
                    variant="outline"
                    className="flex items-center gap-2 border-[#1E293B] text-[#1E293B] hover:bg-[#1E293B]/10"
                    asChild
                  >
                    <a
